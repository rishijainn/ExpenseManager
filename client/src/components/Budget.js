...
function Budget({ budgets, setBudgets, loading, setTotalBud}) {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingBudgetId) {
      ...
      axios
        .patch(`http://localhost:4001/user/data/Budget/update/${editingBudgetId}`, newBudget, { withCredentials: true })
        .then((response) => {
      ...
      axios
        .post('http://localhost:4001/user/data/Budget/post', newBudget, { withCredentials: true })
        .then((response) => {
  ...
  const deleteHandler = (budget) => {
    axios
      .delete(`http://localhost:4001/user/data/Budget/delete/${budget._id}`, { withCredentials: true })
      .then(() => {
